...
results_surprise = q_agent_surprise.learn_environment(env, q_agent_surprise.dyna_q_model_update, q_agent_surprise.dyna_q_planning, q_agent_surprise.q_learning, params_surprise, max_steps, n_episodes)
...
results_novelty = q_agent_novelty.learn_environment(env, q_agent_novelty.dyna_q_model_update, q_agent_novelty.dyna_q_planning, q_agent_novelty.q_learning, params_novelty, max_steps, n_episodes)
